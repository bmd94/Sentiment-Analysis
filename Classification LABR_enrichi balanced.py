...
X=df.review[df.rate==5].iloc[:3072]
X=X.append(df.review[df.rate==1])
y=df.rate[df.rate==5].iloc[:3072]
...
results = open("Resultat_LABR_enrichi_balanced.txt",'w')
